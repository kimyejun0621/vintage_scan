      ...
      <div className="relative bg-black border-2 border-white p-8 overflow-hidden glow-card">
        ...
        <div className="relative">
          ...
          <button 
            ...
            className="w-full py-5 bg-white text-black font-black text-lg uppercase tracking-wider hover:bg-white/90 transition-all duration-300 hover:scale-[1.02] active:scale-[0.98] shadow-xl hover:shadow-2xl"
          >
            Become a Hunter
          </button>
